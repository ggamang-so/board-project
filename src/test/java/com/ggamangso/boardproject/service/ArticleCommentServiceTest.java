...
class ArticleCommentServiceTest {
    ...
    void givenArticleCommentInfo_whenSavingArticleComment_thenSavesArticleComment() {
        ...
        given(userAccountRepository.getReferenceById(dto.userAccountDto().toEntity().getUserId())).willReturn(createUserAccount());
        ...
        then(userAccountRepository).should().getReferenceById(dto.userAccountDto().toEntity().getUserId());
